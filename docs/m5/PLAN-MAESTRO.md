...
> Refinamiento del `docs/m5/PLAN-IMPO-BOOKINGS-MULTIREGION.md` de John, cruzado contra evidencia real:
...
- `docs/historico/GATE-025.md` · `docs/historico/FIX-P1-BAKEOFF.md` · `docs/historico/CP3-VERIFY.md` · `docs/historico/AUDIT-4-DEFINER-RPCS.md`
